...
imagesc(ami1);
colormap gray;
title('absolute magnitude image for Level 1');

subplot(2,2,2)
imagesc(ami2);
title('absolute magnitude image for Level 2');

subplot(2,2,3)
imagesc(ami3);
title('absolute magnitude image for Level 3');

subplot(2,2,4)
imagesc(ami4);
title('absolute magnitude image for Level 4');